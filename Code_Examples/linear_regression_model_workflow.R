...
#model= simple (not true) equation of a larger population
...
#reisuals means distance from each point to the line
#intercepts- where lines crosses y axis
# R-sqaured % of datais explained by our model
...
# Compare models #### if less than 0.05 than they are different
...
# if + than slopes the same intercepts changes(y)
#if * allow y intercept and slope to change
